...
console.log("1 " + hasEmployeesOlderThan65);
...
console.log("2 " + employeeNamedFrederique);
//----------------------------------------
...
console.log("3 " + employeeYoungerThan18);
...
console.log("4 " + everyEmployeeHasPhoneNumber);
//----------------------------------------
// QUESTION 5: Does every id start with '0'?
// Hint: Use every()

const everyIdStartsWith0 = employees.every(
  (employee) => employee.id.charAt(0) === "0"
);

console.log("5 " + everyIdStartsWith0);
...
console.log("6 " + everyEmployeeHasFirstAndLastName);
...
console.log("7 " + employeeLouise33);
//----------------------------------------
...
const employeesSortedByAge = employees
  .filter((employee) => employee.age)
  .sort((a, b) => a.age - b.age);

console.log("10" + employeesSortedByAge);
